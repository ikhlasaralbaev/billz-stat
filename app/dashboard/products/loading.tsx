...
const STEPS_UZ = [
  { icon: "📦", text: "Mahsulotlar ma'lumotlari yuklanmoqda..." },
  { icon: "🔍", text: "Dead stock aniqlanmoqda..." },
  { icon: "🏗️", text: "Overstock tahlil qilinmoqda..." },
  { icon: "📊", text: "Hisobot tayyorlanmoqda..." },
];

const STEPS_RU = [
  { icon: "📦", text: "Загружаем данные товаров..." },
  { icon: "🔍", text: "Определяем dead stock..." },
  { icon: "🏗️", text: "Анализируем оверсток..." },
  { icon: "📊", text: "Подготавливаем отчёт..." },
];
